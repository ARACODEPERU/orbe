                                    ...
                                    <tr>
                                        <td>
                                            <table width="96%" align="center" border="0" cellspacing="0"
                                                cellpadding="0"
                                                style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center; border:1px solid #d3d3d3;"
                                                class="resizeblock">
                                                <tr>
                                                    <td width="12">&nbsp;</td>
                                                    <td>
                                                        <table width="100%" align="center" border="0"
                                                            ...
                                                            <!-- <tr>
                                                                <td style="font:700 30px 'Montserrat', Helvetica, Arial, sans-serif; color:#404040; text-transform:uppercase;">
                                                                    aqui ira un texto auno esta definido que abra
                                                                </td>
                                                            </tr> -->
                                                            <tr>
                                                                <td height="34">&nbsp;</td>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    style="font:bold 18px Arial, Helvetica, sans-serif; color:#f27b69;">
                                                                    {{ $contact['gender'] == 'M' ? 'Sr.' : 'Sra.' }}
                                                                    {{ $contact['full_name'] }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td class="heightsmalldevices" height="72">&nbsp;
                                                                </td>
                                                            </tr>
                                                        </table>
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" bgcolor="#b5637e" border="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td>
                                                        <table width="340" border="0" cellspacing="0"

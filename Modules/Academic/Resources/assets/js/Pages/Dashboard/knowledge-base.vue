                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
                    <template v-for="(item, index) in interests.popularCourses">
                        <div class="space-y-5 rounded-md border border-white-light bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#1B2E4B] dark:bg-black" >
                            ...
                            <h5 class="text-xl dark:text-white">{{ item.description }}</h5>
                            <template v-if="item.teacher_id">
                                <div class="flex">
                                    <div class="me-4 overflow-hidden rounded-full bg-white-dark">
                                        <img :src="`${urlBasek}storage/${item.person_image}`" class="h-11 w-11 object-cover" alt="profile1" />
                                    </div>
                                    <div class="flex-1">
                                        <h4 class="mb-1.5 font-semibold dark:text-white">{{ item.person_names }}</h4>
                                        <p>{{ item.father_lastname }}</p>
                                    </div>
                                </div>
                            </template>
                    ...
                    <template v-for="(article, i) in  interests.popularArticles" :key="i">
                        <div class="space-y-5 rounded-md border border-white-light bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#1B2E4B] dark:bg-black" >
                            <div class="relative h-[340px] overflow-hidden rounded-md group">
                                ...
                                <Link
                                    :href="route('blog_article_show_studante',article.url)"
                                    type="button"
